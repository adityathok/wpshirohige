	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'wpshirohige' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'wpshirohige' ); ?></th>
			</tr>
		</thead>
		<tbody>
