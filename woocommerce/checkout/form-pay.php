	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'wpmulai' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'wpmulai' ); ?></th>
			</tr>
		</thead>
		<tbody>
